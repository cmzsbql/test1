...
class CrossCondTransBase(nn.Module):
    ...
    def __init__(self, 
        ...
        # # #lstm block
        #self.blocks = StackedLSTM(embed_dim, embed_dim, num_layers, batch_first=True)#lstm
...
class StackedLSTM(nn.Module):
    def __init__(self, input_size, hidden_size, num_layers,batch_first=True, bidirectional=False):
        ...
        self.linear_layers = nn.ModuleList([nn.Linear(hidden_size, hidden_size) for _ in range(num_layers)])
